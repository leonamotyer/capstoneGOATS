...
export default function Events() {
  ...
  useEffect(() => {
    ...
    if (maxDistance) {
      filtered = filtered.filter((event) => event.distance <= parseFloat(maxDistance));
    }
  ...
  return (
    <div className="events-page">
      ...
      <div className="additional-filters grid grid-cols-2 gap-4 mb-6">
        {/* Date Filter */}
        <div>
          <label htmlFor="date-filter" className="block text-primary-dark font-medium mb-2">
            Filter by Date
          </label>
          <input
            type="date"
        ...
        {/* Distance Filter */}
        <div>
          <label htmlFor="distance-filter" className="block text-primary-dark font-medium mb-2">
