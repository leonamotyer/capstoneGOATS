...
export const metadata = {
  title: 'Login | YYC Food Trucks',
  description: 'Login to manage your schedule and events',
};
...
>>>>>>> 2dbbfb0ec4791d4ac5b4b82084546ff281026267
          ...
          <main className="container dashboard-grid min-h-screen bg-gradient-to-br from-green-100 via-yellow-100 to-green-200">
